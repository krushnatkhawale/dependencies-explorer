var ConceptMap = function(chartElementId, infoElementId, dataJson) {
    /*
    U = Central block width
    a = Concept map div Width
    c = Concept map div height
    */

    var a = 800, c = 600, h = c, U = 200, K = 22, S = 20, s = 8, R = 50, J = 30, o = 15, t = 10, w = 1000, F = "elastic", N = "#0da4d3";
    var T, q, x, j, H, A, P;
    var L = {},
        k = {};
    var i, y;
